...
> Campaign: upstream (media stack) | Kind: preserved analysis | The wider
> refactor analysis these plans were drawn from; superseded by the current
> campaign docs where they disagree. Read ../../overview.md first.
...
- `refactor-overview.md`: the whole-refactor framing and document index, including
  ...
  structure by `../../overview.md`; kept for the broader framing.
...
- `refactor-upstream-plan.md`: the earlier PR-program write-up. Superseded as the
  actionable plan by `../../overview.md` plus the `../base`, `../codec`,
...
For the codec and capture upstream campaign itself, start at `../../overview.md`
