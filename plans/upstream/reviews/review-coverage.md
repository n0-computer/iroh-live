...
| Opus enc/dec | COVERED | `../audio/opus-improvements.md` (merge into moq-audio) |
| PCM enc/dec | COVERED | `../audio/pcm.md` (offer; likely declined, plan states low value) |
...
| Opus runtime set_bitrate, lookahead pre-skip, FEC/DTX ctls, channel remix | COVERED | `../audio/opus-improvements.md` (FEC/PLC reserved as groundwork per phase-3c) |
| PCM uncompressed test path | COVERED | `../audio/pcm.md` |
