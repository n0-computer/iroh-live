...
| D5 | NV12 render pass | 75 | 35 | 40 | trivial | none | **done** (7bebb89) |
...
D1, D2, D3, D5, D8, D9 are complete (~510 lines reduced). D6 is the only
trivial remaining item. D4 and D7 are small cleanup tasks. D11 requires a
